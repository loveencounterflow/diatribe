(function() {
  ...
  Programmatic_dialog = class Programmatic_dialog {
    ...
    constructor(exp_steps) {
      ...
      this._exp_keys = Object.keys(this.exp_steps);
      this._pc = -1;
      this.act_steps = {};
      this.results = {};
      //.......................................................................................................
    ...
    _next(ref) {
      ...
      this._pc++;
      if (((key = (ref1 = this._exp_keys[this._pc]) != null ? ref1 : null) == null) || ((R = (ref2 = this.exp_steps[key]) != null ? ref2 : null) == null)) {
    ...
    async _step(act_key, cfg) {
      ...
      //.......................................................................................................
      if (act_key === exp_key) {
        this.act_steps[ref] = act_key;
      } else {
        this.act_steps[ref] = new E.Misstep_failure(`step#${this._pc}: act ${rpr(act_key)}, exp ${rpr(exp_key)}`);
      }
