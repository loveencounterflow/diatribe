(function() {
  ...
  Programmatic_dialog = class Programmatic_dialog {
    ...
    constructor(exp_steps) {
      ...
      this._exp_step_list = this._compile_steps();
      this._pc = -1;
      this.act_steps = {};
      this.results = {};
      //.......................................................................................................
    ...
    _next(ref) {
      var message;
      this._pc++;
      if (this._pc >= this._exp_step_list.length) {
        message = `emergency halt, running too long: act ${this._count_act_steps()} exp ${this._exp_step_list.length}`;
        this._fail(ref, new E.Overrun_failure(message));
        throw new E.Overrun_error(message);
      }
      return this._exp_step_list[this._pc];
    }
    ...
    //---------------------------------------------------------------------------------------------------------
    async _step(dlg_name, dlg_cfg) {
      var act_ref, answer, exp_dlg_name, exp_ref, message, ref1;
      ...
      //.......................................................................................................
      ({exp_ref, exp_dlg_name, answer} = this._next(act_ref));
      this.results[act_ref] = answer;
    ...
    _is_finished() {
      return this._count_act_steps() === this._exp_step_list.length;
    }
    ...
    finish(...P) {
      ...
      this._fail('$finish', new E.Underrun_failure(`finished too early: act ${this._count_act_steps()} exp ${this._exp_step_list.length}`));
      return false;
    }
