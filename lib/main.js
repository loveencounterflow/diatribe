(function() {
  ...
  Programmatic_dialog = class Programmatic_dialog {
    ...
    //---------------------------------------------------------------------------------------------------------
    async _step(act_ref, cfg) {
      var exp_ref, message, ref, ref1, value;
      ...
      //.......................................................................................................
      [exp_ref, value] = this._next(ref);
      this.results[ref] = value;
      //.......................................................................................................
      if (act_ref === exp_ref) {
        this.act_steps[ref] = act_ref;
      } else {
        this.act_steps[ref] = new E.Misstep_failure(`step#${this._pc}: act ${rpr(act_ref)}, exp ${rpr(exp_ref)}`);
      }
